...
var showAllUrls = function showAllUrls(isInstagram, AllUrls, img, title) {
  ...
  var linksHtml = AllUrls.reduce(function (acc, e) {
    ...
    if (e.type === "mp4") {
      linkHtml = "\n\t\t\t<div class=\"linkUrl\">\n\t\t\t<a href=\"".concat(e.url, "\" class=\"Link\" id=\"video\" target=\"_blank\">High Quality ").concat(e.type, " <i class=\"fa-solid fa-video\"></i></a>\n\t\t\t</div>\n\t\t\t"); // IF Type Is MP3
    } else if (e.type === "opus audio") {
      linkHtml = "\n\t\t\t<div class=\"linkUrl\">\n\t\t\t<a href=\"".concat(e.url, "\" class=\"Link\" id=\"audio\" target=\"_blank\">").concat(e.quality, " mp3 ").concat(e.attr["class"], " <i class=\"fa-solid fa-music\"></i></a>\n\t\t\t</div>\n\t\t\t"); // IF Type Is Photo
    } else if (["jpg", "jpeg", "png", "webp", "gif"].includes(e.type)) {
      linkHtml = "\n\t\t\t<div class=\"linkUrl\">\n\t\t\t<a href=\"".concat(e.img, "\">\n\t\t\t<a href=\"").concat(e.url, "\" class=\"Link\" id=\"audio\" target=\"_blank\"><i class=\"fa-solid fa-image\"></i> ").concat(e.type, "</a>\n\t\t\t</a>\n\t\t\t</div>\n\t\t\t");
    }
...
//# sourceMappingURL=insta.dev.js.map

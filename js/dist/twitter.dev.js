...
var showAllUrls = function showAllUrls(isTwitter, AllUrls, img, title) {
  // If the video is from Twitter
  if (isTwitter === "twitter.com") {
    ...
    .filter(function (e) {
      ...
      return "\n\t\t<div class=\"linkUrl\">\n\t\t\t<a href=\"".concat(e.url, "\" class=\"Link\" id=\"video\" target=\"_blank\">").concat(e.subname, "p ").concat(e.type, " <i class=\"fa-solid fa-video\"></i></a>\n\t\t</div>\n\t\t");
